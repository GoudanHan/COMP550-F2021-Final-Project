...
data_Khilnani = pd.read_csv('/content/drive/MyDrive/data_100_new.csv')
...
# when training on the 100 tweets dataset, the parameter BATCH_SIZE has to be changed accordingly by the prompt of error message
# this is due to the sparsity of data
